defmodule SvgLiveDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SvgLiveDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SvgLiveDemoWeb.Gettext, "errors", msg, opts)
    end
  end
